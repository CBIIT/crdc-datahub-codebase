module.exports = Object.freeze({
    EMAIL_NOTIFICATIONS: {
        ...
        SUBMISSION_REQUEST: {
            ...
            REQUEST_CONDITIONALLY_APPROVED: "submission_request:conditionally_approved",
            REQUEST_PENDING_DBGAPID: "submission_request:pending_dbgapid",
            REQUEST_PENDING_MODEL_UPDATE: "submission_request:pending_model_update",
            REQUEST_PENDING_IMAGE_DEIDENTIFICATION: "submission_request:pending_image_deidentification",
            REQUEST_REOPENED: "submission_request:reopened"
        },
        USER_ACCOUNT: {
    ...
    SUBMISSION_REQUEST: {
        ...
        REOPEN: "submission_request:reopen",
    },
    DATA_SUBMISSION: {
