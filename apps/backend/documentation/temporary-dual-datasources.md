...
**Driver split:** Mongoose **9.6.1** uses a nested MongoDB Node driver **7.x**. Prisma, `connect-mongo` sessions, and migration scripts continue to use the top-level `mongodb@5` dependency. Treat these as separate client stacks.
