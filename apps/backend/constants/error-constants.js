const ERROR = {
    ...
    // Submission Request
    SUBMISSION_REQUEST_NOT_FOUND: "The provided submission request ID was not found in the database. Provided _id: ",
    FAILED_DELETE_SUBMISSION_REQUEST: "An error occurred while deleting a submission request",
    SUBMISSION_REQUEST_CONTROLLED_ACCESS_NOT_FOUND: "The submission request does not store controlled access property.",
    SUBMISSION_REQUEST_INVALID_STATUSES: "Requested statuses $item$ are not valid",
    LIST_SUBMISSION_REQUESTS_FETCH_FAILED: "Failed to query the submission requests list.",
    LIST_SUBMISSION_REQUESTS_INVALID_PARAMS: "Invalid list submission requests parameters.",
    FAILED_RESTORE_SUBMISSION_REQUEST: "An error occurred while restoring a submission request",
    MISSING_PROGRAM_INFO: "The program property is required to approve the submission request.",
    INVALID_SUBMISSION_REQUEST_RESTORE_STATE: "Failed to restore submission request because the submission request history data is invalid",
    INVALID_SUBMISSION_REQUEST_RESTORE_NEWER_REVISION_EXISTS: "This submission request cannot be restored because a newer revision exists.",
    COMMENT_LIMIT: "comment cannot exceed $item$ characters.",
    UPDATE_FAILED: "Update unsuccessful",
    VERIFY: {
        UNDEFINED_SUBMISSION_REQUEST: "Submission request array is undefined",
        EMPTY_SUBMISSION_REQUEST: "Submission request array is empty",
        UNDEFINED_STATUS_SUBMISSION_REQUEST: "Submission request state is undefined",
        INVALID_STATE_SUBMISSION_REQUEST: "Submission request state is invalid",
        // Batch
    ...
    INVALID_PERMISSION: "You do not have permission to view this submission request",
