from common.constants import SRF_PROGRAM, SRF_NAME, SRF_ACRONYM, SRF_DESCRIPTION, SRF_STUDY, SYSTEM_PROGRAM_NAME, SYSTEM_PROGRAM_ACRONYM, SYSTEM_PROGRAM_DESCRIPTION, \
     SYSTEM_STUDY_NAME, SYSTEM_STUDY_ACRONYM, SYSTEM_STUDY_DESCRIPTION
import json
...
SRF_PROP_MAPPING = {
    ...
    SYSTEM_PROGRAM_ACRONYM: {
        NODE: SRF_PROGRAM,
        PROP: SRF_ACRONYM
    }, 
    SYSTEM_PROGRAM_DESCRIPTION: {
        NODE: SRF_PROGRAM,
    ...
    SYSTEM_STUDY_ACRONYM: {
        NODE: SRF_STUDY,
        PROP: SRF_ACRONYM
    },
    SYSTEM_STUDY_DESCRIPTION: {
        NODE: SRF_STUDY,
        PROP: SRF_DESCRIPTION
    }
}
