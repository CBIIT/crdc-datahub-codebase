    ...
    def load_data(self, file_path_list):
        ...
        for file in file_path_list:
            ...
            try:
                ...
                df = (df.rename(columns=lambda x: x.strip())).apply(lambda x: x.str.strip() if pd.api.types.is_string_dtype(x) else x) # stripe white space.  covers both legacy object dtype and pandas' newer str dtype
